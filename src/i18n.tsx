...
const enUs: TranslationTable = {
  ...
  "message.exchangeSuccess": "Exchanged for 1 {seed} seed.",
  ...
  "garden.exchangeRule": "Spend 1 bok choy to get 1 cabbage seed.",
...
const zhCn: TranslationTable = {
  ...
  "message.exchangeSuccess": "已兑换 1 颗 {seed} 种子。",
  ...
  "garden.exchangeRule": "消耗 1 个小青菜，可换 1 颗卷心菜种子。",
